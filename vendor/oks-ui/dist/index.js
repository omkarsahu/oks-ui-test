...
var Button = forwardRef(
  (props, ref) => {
    ...
    const skipMouseRippleRef = useRef(false);
    ...
    const defaultSpinner = /* @__PURE__ */ jsx("span", { className: "oksButtonSpinner", "aria-hidden": "true" });
    ...
    const buttonElement = /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        children: [
          ripples.map((ripple) => /* @__PURE__ */ jsx(
            "span",
            {
          ...
          isLoading && spinnerPlacement === "start" && !iconOnlyLoading ? /* @__PURE__ */ jsx("span", { className: "oksButtonSpinnerSlot", "data-placement": "start", children: resolvedSpinner }) : null,
          startContent !== void 0 ? /* @__PURE__ */ jsx("span", { className: "oksButtonStartContent", children: startContent }) : null,
          iconOnlyLoading ? /* @__PURE__ */ jsx("span", { className: "oksButtonIconOnly", "aria-hidden": "true", children: resolvedSpinner }) : isIconOnly ? /* @__PURE__ */ jsx("span", { className: "oksButtonIconOnly", children }) : children !== void 0 && children !== null ? /* @__PURE__ */ jsx("span", { className: "oksButtonLabel", children }) : null,
          endContent !== void 0 ? /* @__PURE__ */ jsx("span", { className: "oksButtonEndContent", children: endContent }) : null,
          isLoading && spinnerPlacement === "end" && !iconOnlyLoading ? /* @__PURE__ */ jsx("span", { className: "oksButtonSpinnerSlot", "data-placement": "end", children: resolvedSpinner }) : null
        ]
      }
    );
...
import { Children, cloneElement, forwardRef as forwardRef2, isValidElement } from "react";
...
import { isValidElement as isValidElement2, cloneElement as cloneElement2 } from "react";
...
function Slot({ children, ...slotProps }) {
  if (!isValidElement2(children)) return null;
  const mergedProps = mergeProps(slotProps, children.props);
  return cloneElement2(children, mergedProps);
}

// src/internal/CloseButton/CloseButton.tsx
import { cloneElement as cloneElement3, forwardRef as forwardRef3, isValidElement as isValidElement3 } from "react";
...
function StatusIcon({ type, size = 18, ...rest }) {
  ...
  if (type === "loading") {
    return /* @__PURE__ */ jsx3("svg", { ...common, children: /* @__PURE__ */ jsx3(
      "path",
      {
...
var CloseButton = forwardRef3(
  ({ ariaLabel, iconSize = 16, icon, iconClassName, ...rest }, ref) => {
    const resolvedIcon = (() => {
      if (icon === void 0) return /* @__PURE__ */ jsx4(CloseIcon, { size: iconSize, className: iconClassName });
      if (!iconClassName) return icon;
      if (isValidElement3(icon))
        return cloneElement3(icon, {
          className: mergeClassName3(icon.props.className, iconClassName)
        });
      return /* @__PURE__ */ jsx4("span", { className: iconClassName, children: icon });
    })();
    return /* @__PURE__ */ jsx4("button", { ref, type: "button", "aria-label": ariaLabel, ...rest, children: resolvedIcon });
  }
);
...
function isToastOptions(value) {
  ...
  if (isValidElement4(value)) return false;
  const v = value;
...
function ToastRow({
  ...
  const timerId = useRef2(null);
  const startedAt = useRef2(0);
  const remainingMs = useRef2(duration ?? 0);
  const progressRef = useRef2(null);
  const canShowDurationBar = stackIndex === 0 && item.showDurationBar && duration != null;
  const setDurationBar = useCallback2(
    (ratio, transitionMs) => {
  ...
  const startDurationBar = useCallback2(
    (ms) => {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs3(
        "div",
        {
          ...
          children: [
            item.type === "loading" && item.loadingComponent ? /* @__PURE__ */ jsx5(
              "div",
              {
            ...
            ) : item.showIcon ? /* @__PURE__ */ jsx5(
              "div",
              {
                className: mergeClassName4("oksToastIcon", classNames?.icon),
                "aria-hidden": "true",
                children: item.icon ?? /* @__PURE__ */ jsx5(StatusIcon, { type: item.type })
              }
            ) : null,
            /* @__PURE__ */ jsxs3("div", { className: mergeClassName4("oksToastBody", classNames?.content), children: [
              hasTitle && /* @__PURE__ */ jsx5("div", { className: mergeClassName4("oksToastTitle", classNames?.title), children: item.title }),
            ...
            stackIndex === 0 && (item.action || item.endContent || item.dismissible) && /* @__PURE__ */ jsxs3("div", { className: mergeClassName4("oksToastControls", classNames?.wrapper), children: [
              item.action && /* @__PURE__ */ jsx5(
                "button",
                {
                  type: "button",
              ...
              item.endContent,
              item.dismissible && /* @__PURE__ */ jsx5(
                CloseButton,
                {
                  ariaLabel: "Close",
            ...
            canShowDurationBar && /* @__PURE__ */ jsx5(
              "div",
              {
                className: mergeClassName4(
...
function ToastProvider({
  ...
  const idCounter = useRef2(0);
  const removalTimers = useRef2(/* @__PURE__ */ new Map());
  const [items, dispatch] = useReducer(toastReducer, []);
  const itemsRef = useRef2([]);
  itemsRef.current = items;
  const scheduleRemoval = useCallback2(
    (id) => {
  ...
  return /* @__PURE__ */ jsxs3(ToastContext.Provider, { value: api, children: [
    children,
    /* @__PURE__ */ jsx5(Portal, { container, children: Object.entries(grouped).map(([posKey, list]) => {
      const pos = posKey;
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx5(
            "div",
            {
              ...
              children: visual.map((t, visualIndex) => /* @__PURE__ */ jsx5(
                ToastRow,
                {
                  item: t,
                  dataMotion,
...
function Tooltip(props) {
  ...
  const openTimerRef = useRef3(null);
  ...
  const triggerNode = isValidElement5(children) ? (() => {
  ...
  const tooltipNode = mounted && !isDisabled ? /* @__PURE__ */ jsxs4(
    "div",
    {
      ref: (node) => {
  ...
  return /* @__PURE__ */ jsxs4(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx6(Portal, { container: portalContainer, children: tooltipNode })
  ] });
}

// src/components/Avatar/Avatar.tsx
import React, { forwardRef as forwardRef4, useEffect as useEffect4, useState as useState4 } from "react";
...
var Avatar = forwardRef4((props, ref) => {
  ...
  useEffect4(() => setImgFailed(false), [src]);
  ...
  const fallbackContent = fallback !== void 0 && fallback !== null ? fallback : resolvedName.trim().length > 0 ? /* @__PURE__ */ jsx8(
    "span",
    {
    ...
    "span",
    {
      ...
      "aria-hidden": "true",
      children: icon ?? /* @__PURE__ */ jsx8(AvatarIcon, {})
    }
  );
  const avatarElement = /* @__PURE__ */ jsx8(
    "div",
    {
      ...rest,
      ref,
      ...
      style: rootStyle,
      children: shouldShowFallback ? /* @__PURE__ */ jsx8(
        "span",
        {
  ...
  const tooltipNode = resolvedDisabled ? /* @__PURE__ */ jsx8("span", { className: "oksAvatarTooltipWrapper", children: avatarElement }) : avatarElement;
  return /* @__PURE__ */ jsx8(Tooltip, { ...tooltipProps, content: tooltipContent, children: tooltipNode });
});
            ...
            "div",
            {
              ...
              children: childrenArray.slice(0, resolvedMax).map((child, index) => {
                if (React.isValidElement(child)) {
                  ...
                  return /* @__PURE__ */ jsx8("div", { className: "oksAvatarGroupItem", children: React.cloneElement(child, childProps) }, index);
                }
                return /* @__PURE__ */ jsx8("div", { className: "oksAvatarGroupItem", children: child }, index);
              })
            }
          ),
          resolvedOverflow > 0 ? /* @__PURE__ */ jsx8(
            "span",
            {
              className: mergeClassName6(
...
var Badge = forwardRef5((props, ref) => {
  const {
    children,
    content,
    max,
  ...
  const badgeEl = shouldRenderBadge ? /* @__PURE__ */ jsx9("span", { className: mergeClassName7("oksBadgeBadge", classNames?.badge), children: isDot ? null : displayContent }) : null;
...
var Tabs = forwardRef6(function Tabs2(props, ref) {
  ...
  const disabledSet = useMemo3(() => {
    const set = /* @__PURE__ */ new Set();
    for (const k of disabledKeys ?? []) set.add(k);
    return set;
  }, [disabledKeys]);
  const renderedTabs = useMemo3(() => {
    if (items !== void 0) {
    ...
    const out = [];
    for (const node of Children2.toArray(children)) {
  ...
  const keys = useMemo3(() => renderedTabs.map((t) => t.key), [renderedTabs]);
  const nodeEnv = globalThis?.process?.env?.NODE_ENV;
  if (nodeEnv !== "production") {
    for (const t of items !== void 0 ? [] : Children2.toArray(children)) {
  ...
  const triggerRefs = useRef4(/* @__PURE__ */ new Map());
  const setTriggerRef = useCallback3((k, node) => {
    triggerRefs.current.set(k, node);
  }, []);
  const autoId = useId2();
  const tabsId = useMemo3(() => {
    const base = rest.id ? keyToIdPart(rest.id) : keyToIdPart(`tabs-${autoId}`);
    return `oks-${base}`;
  }, [autoId, rest.id]);
  const getIds = useCallback3(
    (k) => {
  ...
  const cursorRef = useRef4(null);
  const positionCursor = useCallback3(() => {
      ...
      children: [
        /* @__PURE__ */ jsxs8(
          "div",
          {
            ...
            children: [
              variant === "underlined" ? /* @__PURE__ */ jsx10(
                "div",
                {
              ...
              renderedTabs.map((t) => {
                ...
                const content = /* @__PURE__ */ jsx10("span", { className: tabContentClassName, children: t.props.title });
                return /* @__PURE__ */ jsx10("div", { className: tabWrapperClassName, children: t.props.href ? /* @__PURE__ */ jsx10(
                  "a",
                  {
                    ...commonProps,
        ...
        /* @__PURE__ */ jsx10("div", { className: panelsClassName, children: destroyInactiveTabPanel ? activeTab ? /* @__PURE__ */ jsx10(
          "div",
          {
...
import { forwardRef as forwardRef7, useCallback as useCallback4, useEffect as useEffect6, useMemo as useMemo4, useRef as useRef5, useState as useState6 } from "react";
...
var TabsLegacy = forwardRef7(function TabsLegacy2(props, ref) {
  const {
    data,
    defaultTab = 0,
    value,
  ...
  const findDefault = useCallback4(
    (idx) => {
  ...
  const indexFromParam = useCallback4(() => {
      ...
      children: [
        /* @__PURE__ */ jsxs9(
          "div",
          {
            ...
            ref: tablistRef,
            children: [
              effAppearance === "underline" ? /* @__PURE__ */ jsx11("div", { className: "oksTabsIndicator", ref: indicatorRef, "aria-hidden": "true" }) : null,
              items.map((it, i) => {
        ...
        /* @__PURE__ */ jsx11("div", { className: "oksTabsPanels", children: renderLazy ? /* @__PURE__ */ jsx11(
          "div",
          {
...
import { forwardRef as forwardRef8, useCallback as useCallback5, useEffect as useEffect7, useId as useId3, useMemo as useMemo5, useState as useState7 } from "react";
...
var TabsRoot = forwardRef8(
  function TabsRoot2(props, ref) {
    ...
    const [internal, setInternal] = useState7(initial);
    ...
    const autoId = useId3();
    const idsBase = useMemo5(() => {
      const base = id ? toIdPart(id) : toIdPart(`tabs-${autoId}`);
      return `oks-${base}`;
    }, [autoId, id]);
    const getIds = useCallback5(
      (v) => {
    ...
    const rootClass = ["oksTabsRoot", className].filter(Boolean).join(" ");
    return /* @__PURE__ */ jsx12(TabsContext.Provider, { value: ctx, children: /* @__PURE__ */ jsx12(
      "div",
      {
        ref,
        id,
...
import { forwardRef as forwardRef9, useEffect as useEffect8, useRef as useRef6 } from "react";
import { jsx as jsx13, jsxs as jsxs10 } from "react/jsx-runtime";
var TabList = forwardRef9(function TabList2(props, ref) {
  ...
  return /* @__PURE__ */ jsxs10(
    "div",
    {
      ...
      onKeyDown,
      children: [
        ctx.appearance === "underline" ? /* @__PURE__ */ jsx13("div", { className: "oksTabsIndicator", ref: indicatorRef, "aria-hidden": "true" }) : null,
        props.children
      ]
    }
  );
  ...
  function TabTrigger2(props, ref) {
    ...
    return /* @__PURE__ */ jsx14(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx14("span", { className: "oksTabLabel", children })
      }
    );
  }
);
...
var TabPanel = forwardRef11(function TabPanel2(props, ref) {
...
var Chip = forwardRef12((props, ref) => {
  const {
    children,
    variant = "solid",
    size = "md",
  ...
  const closeIcon = endContent ?? /* @__PURE__ */ jsx16("span", { "aria-hidden": "true", children: "\xD7" });
  const closeButton = typeof onClose === "function" ? /* @__PURE__ */ jsx16(
    "button",
    {
      type: "button",
  ...
  const chipElement = /* @__PURE__ */ jsxs11(
    "div",
    {
      ...rest,
      ref,
      ...
      children: [
        ...
        avatar !== void 0 && avatar !== null ? /* @__PURE__ */ jsx16("span", { className: mergeClassName9("oksChipAvatar", classNames?.avatar), children: avatar }) : null,
        startContent,
        children !== void 0 && children !== null ? /* @__PURE__ */ jsx16("span", { className: mergeClassName9("oksChipContent", classNames?.content), children }) : null,
...
function useDropdownMenuContext() {
  const ctx = useContext3(DropdownMenuContext);
  if (!ctx) throw new Error("oks-ui DropdownMenu: missing context.");
  return ctx;
}
function isDropdownItemElement(node) {
  return isValidElement7(node) && node.type === DropdownItem;
}
function isDropdownSectionElement(node) {
  return isValidElement7(node) && node.type === DropdownSection;
}
...
var Dropdown = forwardRef13((props, ref) => {
  const {
    children,
    isOpen,
    defaultOpen = false,
  ...
  const openSourceRef = useRef7("programmatic");
  const menuOnCloseRef = useRef7(void 0);
  const id = useId4();
  ...
  const toggle = useCallback6(() => setOpen(!open, false), [open, setOpen]);
  useEffect9(() => {
    if (!open) return;
    const onKeyDown = (e) => {
      if (e.key !== "Escape") return;
  ...
  return /* @__PURE__ */ jsx17(DropdownContext.Provider, { value: ctx, children: /* @__PURE__ */ jsx17(
    "div",
    {
      ref,
      className: mergeClassName10(mergeClassName10("oksDropdown", classNames?.base), className),
      style,
      children: /* @__PURE__ */ jsx17("div", { className: mergeClassName10("oksDropdownContent", classNames?.content), children })
    }
  ) });
});
Dropdown.displayName = "Dropdown";
var DropdownTrigger = forwardRef13(
  (props, forwardedRef) => {
...
var DropdownMenu = (props) => {
  ...
  const disabledSet = useMemo6(() => toKeySet(disabledKeys), [disabledKeys]);
  const toneVars = useMemo6(
    () => ({
  ...
  const [uncontrolledSelected, setUncontrolledSelected] = useState8(
    () => defaultSelectedKeys === "all" ? "all" : toKeySet(defaultSelectedKeys)
  );
  const resolvedSelected = useMemo6(() => {
  ...
  const setSelectedKeys = useCallback6(
    (next) => {
      if (selectedKeys === void 0) setUncontrolledSelected(next);
    },
    [selectedKeys]
  );
  const { side, align } = useMemo6(
    () => parsePlacement(dropdown.placement),
    [dropdown.placement]
  );
  const [position, setPosition] = useState8(null);
  const itemRefs = useRef7(/* @__PURE__ */ new Map());
  const itemInfo = useRef7(/* @__PURE__ */ new Map());
  ...
  const renderedSections = useMemo6(() => {
    if (items !== void 0) {
      const render = children;
      if (typeof render !== "function") return [];
      const outItems = [];
    ...
    const nodes = Children3.toArray(children);
    const defaultItems = [];
    const sections = [];
    for (const node of nodes) {
      if (isDropdownSectionElement(node)) {
        ...
        if (node.props.items !== void 0) {
          ...
          for (const child of Children3.toArray(node.props.children)) {
  ...
  const keys = useMemo6(() => flattened.map((it) => it.key), [flattened]);
  const itemPropsByKey = useMemo6(() => {
    const map = /* @__PURE__ */ new Map();
    for (const it of flattened) map.set(it.key, it.element.props);
    return map;
  }, [flattened]);
  const computedDisabled = useMemo6(() => {
  ...
  const [focusedKey, setFocusedKey] = useState8(null);
  const registerItemRef = useCallback6((key, node, info) => {
    if (node) itemRefs.current.set(key, node);
    else itemRefs.current.delete(key);
    itemInfo.current.set(key, info);
  }, []);
  const focusKey = useCallback6(
    (key) => {
      setFocusedKey(key);
      if (key === null) return;
  ...
  const handleItemAction = useCallback6(
    (key, item) => {
  ...
  return /* @__PURE__ */ jsx17(Portal, { container: dropdown.portalContainer, children: /* @__PURE__ */ jsx17(DropdownMenuContext.Provider, { value: menuCtx, children: /* @__PURE__ */ jsxs12(
    "div",
    {
      ref: (node) => {
      ...
      children: [
        topContent !== void 0 && topContent !== null ? /* @__PURE__ */ jsx17("div", { className: "oksDropdownTopContent", children: topContent }) : null,
        /* @__PURE__ */ jsx17(
          "div",
          {
            ref: listRef,
            ...
            tabIndex: -1,
            onKeyDown: handleKeyDown,
            children: hasItems ? renderedSections.map((section, idx) => /* @__PURE__ */ jsx17(DropdownSectionView, { section }, idx)) : hideEmptyContent ? null : /* @__PURE__ */ jsx17("div", { className: mergeClassName10("oksDropdownEmpty", classNames?.emptyContent), children: emptyContent ?? null })
          }
        ),
        bottomContent !== void 0 && bottomContent !== null ? /* @__PURE__ */ jsx17("div", { className: "oksDropdownBottomContent", children: bottomContent }) : null
      ]
    }
  ) }) });
};
function DropdownSectionView({ section }) {
  ...
  const heading = section.title !== void 0 && section.title !== null ? /* @__PURE__ */ jsx17("div", { className: mergeClassName10("oksDropdownSectionHeading", section.classNames?.heading), children: section.title }) : null;
  const hasDivider = section.showDivider === true;
  return /* @__PURE__ */ jsxs12("div", { className: mergeClassName10("oksDropdownSection", section.classNames?.base), children: [
    heading,
    /* @__PURE__ */ jsx17(
      "div",
      {
    ...
    hasDivider ? /* @__PURE__ */ jsx17("div", { className: mergeClassName10("oksDropdownSectionDivider", section.classNames?.divider) }) : null
  ] });
}
var DropdownItem = forwardRef13((props, ref) => {
  const {
    children,
    title,
    description,
  ...
  const [isPressedState, setIsPressedState] = useState8(false);
  const startPress = (e) => {
    if (disabled) return;
    if (!isPressedState) {
      onPressStart?.(e);
  ...
  const itemEl = /* @__PURE__ */ jsxs12(
    Component,
    {
      ...
      children: [
        startContent !== void 0 && startContent !== null ? /* @__PURE__ */ jsx17("span", { className: "oksDropdownItemStartContent", "aria-hidden": "true", children: startContent }) : null,
        /* @__PURE__ */ jsxs12(
          "span",
          {
            ...
            children: [
              ...
              description !== void 0 && description !== null ? /* @__PURE__ */ jsx17(
                "span",
                {
                  className: mergeClassName10(
                    mergeClassName10(
        ...
        shortcut !== void 0 && shortcut !== null ? /* @__PURE__ */ jsx17(
          "span",
          {
            className: mergeClassName10(
              mergeClassName10(
        ...
        endContent !== void 0 && endContent !== null ? /* @__PURE__ */ jsx17("span", { className: "oksDropdownItemEndContent", "aria-hidden": "true", children: endContent }) : resolvedSelected && effectiveHideSelectedIcon !== true ? /* @__PURE__ */ jsx17(
          "span",
          {
            className: mergeClassName10(
              mergeClassName10(
  ...
  return showDivider ? /* @__PURE__ */ jsxs12(Fragment2, { children: [
    itemEl,
    /* @__PURE__ */ jsx17("div", { className: "oksDropdownItemDivider", "aria-hidden": "true" })
  ] }) : itemEl;
});
...
import { forwardRef as forwardRef14, useCallback as useCallback7, useMemo as useMemo7, useState as useState9 } from "react";
...
var Alert = forwardRef14((props, ref) => {
  const {
    title,
    description,
    color = "default",
  ...
  const [uncontrolledVisible, setUncontrolledVisible] = useState9(true);
  ...
  const defaultIcon = useMemo7(
    () => /* @__PURE__ */ jsx18(StatusIcon, { type: mapColorToStatusIconType(color), size: 18 }),
    [color]
  );
  ...
  const iconElement = shouldRenderIcon ? /* @__PURE__ */ jsx18("span", { className: mergeClassName11("oksAlertIcon", classNames?.alertIcon), children: resolvedIcon }) : null;
  const iconWrapper = shouldRenderIcon ? hideIconWrapper ? iconElement : /* @__PURE__ */ jsx18(
    "span",
    {
  ...
  const closeButton = isClosable === true ? /* @__PURE__ */ jsx18(
    "button",
    {
      type: "button",
      "aria-label": "Close",
      ...
      children: /* @__PURE__ */ jsx18(CloseIcon, { size: 16 })
    }
  ) : null;
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs13(
          "div",
          {
            ...
            children: [
              hasTitle ? /* @__PURE__ */ jsx18("div", { className: mergeClassName11("oksAlertTitle", classNames?.title), children: title }) : null,
              hasDescription ? /* @__PURE__ */ jsx18(
                "div",
                {
                  className: mergeClassName11(
                    "oksAlertDescription",
...
import { useEffect as useEffect10, useMemo as useMemo8, useRef as useRef8, useState as useState10 } from "react";
...
function Backdrop(props) {
  ...
  const reducedMotion = useReducedMotion();
  const [present, setPresent] = useState10(isOpen);
  const [backdropState, setBackdropState] = useState10(
    "closed"
  );
  const [contentState, setContentState] = useState10("closed");
  const timersRef = useRef8({});
  const durationMs = useMemo8(() => {
    if (reducedMotion) return 0;
    return Math.round(clampNumber(animationDuration, 0, 10) * 1e3);
  }, [animationDuration, reducedMotion]);
  const opacityVar = useMemo8(() => {
    const clamped = clampNumber(backgroundOpacity, 0, 100);
    return String(clamped / 100);
  }, [backgroundOpacity]);
  const rootStyle = useMemo8(() => {
    return {
      zIndex,
      ...style,
  ...
  const content = children !== void 0 && children !== null ? /* @__PURE__ */ jsx19(
    "div",
    {
  ...
  const root = present ? /* @__PURE__ */ jsxs14(
    "div",
    {
  ...
  return /* @__PURE__ */ jsx19(Portal, { container, children: root });
}
    ...
    if (children) {
      return /* @__PURE__ */ jsxs15(
        "div",
        {
          ...
          style: rootStyle,
          children: [
            /* @__PURE__ */ jsx20("span", { className: "oksDividerLine", "aria-hidden": "true" }),
            /* @__PURE__ */ jsx20("span", { className: "oksDividerLabel", children }),
            /* @__PURE__ */ jsx20("span", { className: "oksDividerLine", "aria-hidden": "true" })
          ]
        }
      );
...
import { useEffect as useEffect11, useId as useId5, useMemo as useMemo9, useRef as useRef9 } from "react";
...
function PageTitle(props) {
  ...
  const renderIcon = () => {
    ...
    return /* @__PURE__ */ jsx21("span", { className: mergeClassName14("oksPageTitleIcon", classNames?.icon), children: icon });
  };
  const element = /* @__PURE__ */ jsxs16(
    "div",
    {
  ...
  if (tooltipInfo) {
    ...
    return /* @__PURE__ */ jsx21(Tooltip, { ...tooltipProps, children: element });
  }
  return element;
}
...
function Drawer(props) {
  ...
  const lastFocusedRef = useRef9(null);
  useEffect11(() => {
    if (!isOpen) return;
    if (typeof document === "undefined") return;
  ...
  const resolvedWidth = useMemo9(() => resolveWidth(width), [width]);
  const resolvedHeight = useMemo9(() => resolveHeight(height), [height]);
  const cssVars = useMemo9(() => {
    return {
  ...
  const safeBackdropOverrides = useMemo9(() => {
    if (!backdrop) return {};
    const {
      isOpen: _isOpen,
      onClose: _onClose,
  ...
  const resolvedHeaders = {
    as: "h4",
    ...restHeaders,
    ...headerTitle !== void 0 && headerTitle !== null ? { title: /* @__PURE__ */ jsx22("span", { id: titleId, children: headerTitle }) } : {}
  };
  ...
  return /* @__PURE__ */ jsx22(Backdrop, { isOpen, onClose, ...mergedBackdrop, children: /* @__PURE__ */ jsxs17(
    "div",
    {
      ref: panelRef,
      role: "dialog",
      ...
      ...panelAriaProps,
      children: [
        hasHeader ? /* @__PURE__ */ jsxs17("div", { className: "oksDrawerHeader", children: [
          /* @__PURE__ */ jsx22("div", { className: "oksDrawerHeaderTitle", children: resolvedHeaders.title !== void 0 && resolvedHeaders.title !== null ? /* @__PURE__ */ jsx22(PageTitle, { ...resolvedHeaders }) : null }),
        ...
        /* @__PURE__ */ jsx22("div", { className: "oksDrawerBody", children }),
        actions !== void 0 && actions !== null ? /* @__PURE__ */ jsx22("div", { className: "oksDrawerFooter", children: actions }) : null
      ]
    }
  ) });
}
...
import { useEffect as useEffect12, useId as useId6, useMemo as useMemo10, useRef as useRef10 } from "react";
...
function Modal(props) {
  ...
  const lastFocusedRef = useRef10(null);
  useEffect12(() => {
    if (!isOpen) return;
    if (typeof document === "undefined") return;
    lastFocusedRef.current = document.activeElement;
  ...
  const resolvedWidth = useMemo10(() => resolveWidth2(size), [size]);
  const cssVars = useMemo10(() => {
    return {
  ...
  const safeBackdropOverrides = useMemo10(() => {
    if (!backdrop) return {};
    const {
      isOpen: _isOpen,
      onClose: _onClose,
  ...
  const resolvedHeaders = {
    as: "h4",
    ...restHeaders,
    ...headerTitle !== void 0 && headerTitle !== null ? { title: /* @__PURE__ */ jsx23("span", { id: titleId, children: headerTitle }) } : {}
  };
  const hasHeader = dismissible || resolvedHeaders.title !== void 0;
  const ariaLabelledBy = headerTitle !== void 0 && headerTitle !== null ? titleId : void 0;
  const mergedDivider = {
  ...
  return /* @__PURE__ */ jsx23(Backdrop, { isOpen, onClose, ...mergedBackdrop, children: /* @__PURE__ */ jsxs18(
    "div",
    {
      ref: panelRef,
      role: "dialog",
      ...
      style: rootStyle,
      children: [
        hasHeader ? /* @__PURE__ */ jsxs18("div", { className: "oksModalHeader", children: [
          /* @__PURE__ */ jsx23("div", { className: "oksModalHeaderTitle", children: resolvedHeaders.title !== void 0 && resolvedHeaders.title !== null ? /* @__PURE__ */ jsx23(PageTitle, { ...resolvedHeaders }) : null }),
          dismissible ? /* @__PURE__ */ jsx23(
            CloseButton,
            {
        ...
        hasHeader ? /* @__PURE__ */ jsx23(Divider, { ...mergedDivider }) : null,
        /* @__PURE__ */ jsx23("div", { className: "oksModalBody", children }),
        actions !== void 0 && actions !== null ? /* @__PURE__ */ jsx23("div", { className: "oksModalFooter", children: actions }) : null
      ]
    }
  ) });
}

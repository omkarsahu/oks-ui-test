...
function StatusIcon({ type, size = 18, ...rest }) {
  ...
  if (type === "loading") {
    return /* @__PURE__ */ jsx("svg", { ...common, children: /* @__PURE__ */ jsx(
      "path",
      {
...
var Alert = forwardRef((props, ref) => {
  ...
  const defaultIcon = useMemo(
    () => /* @__PURE__ */ jsx2(StatusIcon, { type: mapColorToStatusIconType(color), size: 18 }),
    [color]
  );
  ...
  const iconElement = shouldRenderIcon ? /* @__PURE__ */ jsx2("span", { className: mergeClassName("oksAlertIcon", classNames?.alertIcon), children: resolvedIcon }) : null;
  const iconWrapper = shouldRenderIcon ? hideIconWrapper ? iconElement : /* @__PURE__ */ jsx2(
    "span",
    {
  ...
  const closeButton = isClosable === true ? /* @__PURE__ */ jsx2(
    "button",
    {
      type: "button",
      "aria-label": "Close",
      ...
      children: /* @__PURE__ */ jsx2(CloseIcon, { size: 16 })
    }
  ) : null;
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs2(
          "div",
          {
            ...
            children: [
              hasTitle ? /* @__PURE__ */ jsx2("div", { className: mergeClassName("oksAlertTitle", classNames?.title), children: title }) : null,
              hasDescription ? /* @__PURE__ */ jsx2(
                "div",
                {
                  className: mergeClassName(
                    "oksAlertDescription",
...
import React, { forwardRef as forwardRef2, useEffect as useEffect3, useState as useState4 } from "react";
...
function Tooltip(props) {
  ...
  const triggerNode = isValidElement2(children) ? (() => {
  ...
  const actualPlacement = useMemo2(() => {
  ...
  const tooltipNode = mounted && !isDisabled ? /* @__PURE__ */ jsxs3(
    "div",
    {
      ref: (node) => {
  ...
  return /* @__PURE__ */ jsxs3(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx3(Portal, { container: portalContainer, children: tooltipNode })
  ] });
}
...
var Avatar = forwardRef2((props, ref) => {
  ...
  const [imgFailed, setImgFailed] = useState4(false);
  useEffect3(() => setImgFailed(false), [src]);
  ...
  const fallbackContent = fallback !== void 0 && fallback !== null ? fallback : resolvedName.trim().length > 0 ? /* @__PURE__ */ jsx5(
    "span",
    {
    ...
    "span",
    {
      ...
      "aria-hidden": "true",
      children: icon ?? /* @__PURE__ */ jsx5(AvatarIcon, {})
    }
  );
  const avatarElement = /* @__PURE__ */ jsx5(
    "div",
    {
      ...rest,
      ref,
      ...
      style: rootStyle,
      children: shouldShowFallback ? /* @__PURE__ */ jsx5(
        "span",
        {
  ...
  const tooltipNode = resolvedDisabled ? /* @__PURE__ */ jsx5("span", { className: "oksAvatarTooltipWrapper", children: avatarElement }) : avatarElement;
  return /* @__PURE__ */ jsx5(Tooltip, { ...tooltipProps, content: tooltipContent, children: tooltipNode });
});
            ...
            "div",
            {
              ...
              children: childrenArray.slice(0, resolvedMax).map((child, index) => {
                if (React.isValidElement(child)) {
                  ...
                  return /* @__PURE__ */ jsx5("div", { className: "oksAvatarGroupItem", children: React.cloneElement(child, childProps) }, index);
                }
                return /* @__PURE__ */ jsx5("div", { className: "oksAvatarGroupItem", children: child }, index);
              })
            }
          ),
          resolvedOverflow > 0 ? /* @__PURE__ */ jsx5(
            "span",
            {
              className: mergeClassName3(
...
import { useEffect as useEffect4, useMemo as useMemo3, useRef as useRef2, useState as useState5 } from "react";
...
function Backdrop(props) {
  ...
  const reducedMotion = useReducedMotion();
  const [present, setPresent] = useState5(isOpen);
  const [backdropState, setBackdropState] = useState5(
    "closed"
  );
  const [contentState, setContentState] = useState5("closed");
  const timersRef = useRef2({});
  const durationMs = useMemo3(() => {
    if (reducedMotion) return 0;
    return Math.round(clampNumber(animationDuration, 0, 10) * 1e3);
  }, [animationDuration, reducedMotion]);
  const opacityVar = useMemo3(() => {
  ...
  const content = children !== void 0 && children !== null ? /* @__PURE__ */ jsx6(
    "div",
    {
  ...
  const root = present ? /* @__PURE__ */ jsxs6(
    "div",
    {
  ...
  return /* @__PURE__ */ jsx6(Portal, { container, children: root });
}
...
var Badge = forwardRef3((props, ref) => {
  const {
    children,
    content,
    max,
  ...
  const badgeEl = shouldRenderBadge ? /* @__PURE__ */ jsx7("span", { className: mergeClassName5("oksBadgeBadge", classNames?.badge), children: isDot ? null : displayContent }) : null;
...
import { forwardRef as forwardRef4, useCallback as useCallback2, useRef as useRef3, useState as useState6 } from "react";
...
var Button = forwardRef4(
  (props, ref) => {
    ...
    const [ripples, setRipples] = useState6([]);
    const skipMouseRippleRef = useRef3(false);
    ...
    const [isFocusVisible, setIsFocusVisible] = useState6(false);
    ...
    const createRipple = useCallback2(
      (button, x, y) => {
    ...
    const removeRipple = useCallback2((id) => {
    ...
    const defaultSpinner = /* @__PURE__ */ jsx8("span", { className: "oksButtonSpinner", "aria-hidden": "true" });
    const resolvedSpinner = spinner ?? defaultSpinner;
    const iconOnlyLoading = isIconOnly && isLoading;
    const buttonElement = /* @__PURE__ */ jsxs8(
      "button",
      {
        ...rest,
        ...
        style: { ...toneVars, ...style },
        children: [
          ripples.map((ripple) => /* @__PURE__ */ jsx8(
            "span",
            {
          ...
          isLoading && spinnerPlacement === "start" && !iconOnlyLoading ? /* @__PURE__ */ jsx8("span", { className: "oksButtonSpinnerSlot", "data-placement": "start", children: resolvedSpinner }) : null,
          startContent !== void 0 ? /* @__PURE__ */ jsx8("span", { className: "oksButtonStartContent", children: startContent }) : null,
          iconOnlyLoading ? /* @__PURE__ */ jsx8("span", { className: "oksButtonIconOnly", "aria-hidden": "true", children: resolvedSpinner }) : isIconOnly ? /* @__PURE__ */ jsx8("span", { className: "oksButtonIconOnly", children }) : children !== void 0 && children !== null ? /* @__PURE__ */ jsx8("span", { className: "oksButtonLabel", children }) : null,
          endContent !== void 0 ? /* @__PURE__ */ jsx8("span", { className: "oksButtonEndContent", children: endContent }) : null,
          isLoading && spinnerPlacement === "end" && !iconOnlyLoading ? /* @__PURE__ */ jsx8("span", { className: "oksButtonSpinnerSlot", "data-placement": "end", children: resolvedSpinner }) : null
        ]
      }
    );
...
import { Children, cloneElement as cloneElement3, forwardRef as forwardRef5, isValidElement as isValidElement3 } from "react";
...
var ButtonGroup = forwardRef5(
  (props, ref) => {
    ...
    const enhancedChildren = Children.map(children, (child) => {
      if (!isValidElement3(child) || child.type !== Button) return child;
      const nextProps = {};
      ...
      return cloneElement3(child, nextProps);
    });
...
var Chip = forwardRef6((props, ref) => {
  ...
  const closeIcon = endContent ?? /* @__PURE__ */ jsx10("span", { "aria-hidden": "true", children: "\xD7" });
  const closeButton = typeof onClose === "function" ? /* @__PURE__ */ jsx10(
    "button",
    {
      type: "button",
  ...
  const chipElement = /* @__PURE__ */ jsxs9(
    "div",
    {
      ...rest,
      ref,
      ...
      children: [
        ...
        avatar !== void 0 && avatar !== null ? /* @__PURE__ */ jsx10("span", { className: mergeClassName8("oksChipAvatar", classNames?.avatar), children: avatar }) : null,
        startContent,
        children !== void 0 && children !== null ? /* @__PURE__ */ jsx10("span", { className: mergeClassName8("oksChipContent", classNames?.content), children }) : null,
    ...
    if (children) {
      return /* @__PURE__ */ jsxs10(
        "div",
        {
          ...
          style: rootStyle,
          children: [
            /* @__PURE__ */ jsx11("span", { className: "oksDividerLine", "aria-hidden": "true" }),
            /* @__PURE__ */ jsx11("span", { className: "oksDividerLabel", children }),
            /* @__PURE__ */ jsx11("span", { className: "oksDividerLine", "aria-hidden": "true" })
          ]
        }
      );
...
import { useEffect as useEffect5, useId as useId2, useMemo as useMemo4, useRef as useRef4 } from "react";
...
function PageTitle(props) {
  ...
  const renderIcon = () => {
    ...
    return /* @__PURE__ */ jsx12("span", { className: mergeClassName10("oksPageTitleIcon", classNames?.icon), children: icon });
  };
  const element = /* @__PURE__ */ jsxs11(
    "div",
    {
  ...
  if (tooltipInfo) {
    ...
    return /* @__PURE__ */ jsx12(Tooltip, { ...tooltipProps, children: element });
  }
  return element;
}

// src/internal/CloseButton/CloseButton.tsx
import { cloneElement as cloneElement4, forwardRef as forwardRef8, isValidElement as isValidElement4 } from "react";
...
var CloseButton = forwardRef8(
  ({ ariaLabel, iconSize = 16, icon, iconClassName, ...rest }, ref) => {
    const resolvedIcon = (() => {
      if (icon === void 0) return /* @__PURE__ */ jsx13(CloseIcon, { size: iconSize, className: iconClassName });
      if (!iconClassName) return icon;
      if (isValidElement4(icon))
        return cloneElement4(icon, {
          className: mergeClassName11(icon.props.className, iconClassName)
        });
      return /* @__PURE__ */ jsx13("span", { className: iconClassName, children: icon });
    })();
    return /* @__PURE__ */ jsx13("button", { ref, type: "button", "aria-label": ariaLabel, ...rest, children: resolvedIcon });
  }
);
...
function Drawer(props) {
  ...
  const lastFocusedRef = useRef4(null);
  useEffect5(() => {
    if (!isOpen) return;
    if (typeof document === "undefined") return;
  ...
  const resolvedWidth = useMemo4(() => resolveWidth(width), [width]);
  const resolvedHeight = useMemo4(() => resolveHeight(height), [height]);
  ...
  const safeBackdropOverrides = useMemo4(() => {
    if (!backdrop) return {};
    const {
      isOpen: _isOpen,
      onClose: _onClose,
  ...
  const resolvedHeaders = {
    as: "h4",
    ...restHeaders,
    ...headerTitle !== void 0 && headerTitle !== null ? { title: /* @__PURE__ */ jsx14("span", { id: titleId, children: headerTitle }) } : {}
  };
  ...
  return /* @__PURE__ */ jsx14(Backdrop, { isOpen, onClose, ...mergedBackdrop, children: /* @__PURE__ */ jsxs12(
    "div",
    {
      ref: panelRef,
      role: "dialog",
      ...
      ...panelAriaProps,
      children: [
        hasHeader ? /* @__PURE__ */ jsxs12("div", { className: "oksDrawerHeader", children: [
          /* @__PURE__ */ jsx14("div", { className: "oksDrawerHeaderTitle", children: resolvedHeaders.title !== void 0 && resolvedHeaders.title !== null ? /* @__PURE__ */ jsx14(PageTitle, { ...resolvedHeaders }) : null }),
        ...
        /* @__PURE__ */ jsx14("div", { className: "oksDrawerBody", children }),
        actions !== void 0 && actions !== null ? /* @__PURE__ */ jsx14("div", { className: "oksDrawerFooter", children: actions }) : null
      ]
    }
  ) });
}
...
function isDropdownItemElement(node) {
  return isValidElement5(node) && node.type === DropdownItem;
}
function isDropdownSectionElement(node) {
  return isValidElement5(node) && node.type === DropdownSection;
}
...
var Dropdown = forwardRef9((props, ref) => {
  const {
    children,
    isOpen,
    defaultOpen = false,
  ...
  const [uncontrolledOpen, setUncontrolledOpen] = useState7(defaultOpen);
  const open = isOpen !== void 0 ? isOpen : uncontrolledOpen;
  const triggerRef = useRef5(null);
  const menuRef = useRef5(null);
  const openSourceRef = useRef5("programmatic");
  const menuOnCloseRef = useRef5(void 0);
  const id = useId3();
  ...
  const toggle = useCallback3(() => setOpen(!open, false), [open, setOpen]);
  useEffect6(() => {
    if (!open) return;
    const onKeyDown = (e) => {
  ...
  return /* @__PURE__ */ jsx15(DropdownContext.Provider, { value: ctx, children: /* @__PURE__ */ jsx15(
    "div",
    {
      ref,
      className: mergeClassName13(mergeClassName13("oksDropdown", classNames?.base), className),
      style,
      children: /* @__PURE__ */ jsx15("div", { className: mergeClassName13("oksDropdownContent", classNames?.content), children })
    }
  ) });
});
Dropdown.displayName = "Dropdown";
var DropdownTrigger = forwardRef9(
  (props, forwardedRef) => {
...
var DropdownMenu = (props) => {
  ...
  const disabledSet = useMemo5(() => toKeySet(disabledKeys), [disabledKeys]);
  const toneVars = useMemo5(
    () => ({
  ...
  const [uncontrolledSelected, setUncontrolledSelected] = useState7(
    () => defaultSelectedKeys === "all" ? "all" : toKeySet(defaultSelectedKeys)
  );
  const resolvedSelected = useMemo5(() => {
  ...
  const setSelectedKeys = useCallback3(
    (next) => {
      if (selectedKeys === void 0) setUncontrolledSelected(next);
    },
    [selectedKeys]
  );
  const { side, align } = useMemo5(
    () => parsePlacement(dropdown.placement),
    [dropdown.placement]
  );
  const [position, setPosition] = useState7(null);
  const itemRefs = useRef5(/* @__PURE__ */ new Map());
  const itemInfo = useRef5(/* @__PURE__ */ new Map());
  const typeaheadRef = useRef5({
    buffer: "",
    timer: null
  });
  ...
  const renderedSections = useMemo5(() => {
    if (items !== void 0) {
    ...
    const nodes = Children2.toArray(children);
    const defaultItems = [];
    const sections = [];
    for (const node of nodes) {
      if (isDropdownSectionElement(node)) {
        ...
        if (node.props.items !== void 0) {
          ...
          for (const child of Children2.toArray(node.props.children)) {
  ...
  const keys = useMemo5(() => flattened.map((it) => it.key), [flattened]);
  const itemPropsByKey = useMemo5(() => {
    const map = /* @__PURE__ */ new Map();
    for (const it of flattened) map.set(it.key, it.element.props);
    return map;
  }, [flattened]);
  const computedDisabled = useMemo5(() => {
  ...
  const [focusedKey, setFocusedKey] = useState7(null);
  const registerItemRef = useCallback3((key, node, info) => {
    if (node) itemRefs.current.set(key, node);
    else itemRefs.current.delete(key);
    itemInfo.current.set(key, info);
  }, []);
  const focusKey = useCallback3(
    (key) => {
      setFocusedKey(key);
      if (key === null) return;
  ...
  const handleItemAction = useCallback3(
    (key, item) => {
  ...
  return /* @__PURE__ */ jsx15(Portal, { container: dropdown.portalContainer, children: /* @__PURE__ */ jsx15(DropdownMenuContext.Provider, { value: menuCtx, children: /* @__PURE__ */ jsxs13(
    "div",
    {
      ref: (node) => {
      ...
      children: [
        topContent !== void 0 && topContent !== null ? /* @__PURE__ */ jsx15("div", { className: "oksDropdownTopContent", children: topContent }) : null,
        /* @__PURE__ */ jsx15(
          "div",
          {
            ref: listRef,
            ...
            tabIndex: -1,
            onKeyDown: handleKeyDown,
            children: hasItems ? renderedSections.map((section, idx) => /* @__PURE__ */ jsx15(DropdownSectionView, { section }, idx)) : hideEmptyContent ? null : /* @__PURE__ */ jsx15("div", { className: mergeClassName13("oksDropdownEmpty", classNames?.emptyContent), children: emptyContent ?? null })
          }
        ),
        bottomContent !== void 0 && bottomContent !== null ? /* @__PURE__ */ jsx15("div", { className: "oksDropdownBottomContent", children: bottomContent }) : null
      ]
    }
  ) }) });
};
function DropdownSectionView({ section }) {
  ...
  const heading = section.title !== void 0 && section.title !== null ? /* @__PURE__ */ jsx15("div", { className: mergeClassName13("oksDropdownSectionHeading", section.classNames?.heading), children: section.title }) : null;
  const hasDivider = section.showDivider === true;
  return /* @__PURE__ */ jsxs13("div", { className: mergeClassName13("oksDropdownSection", section.classNames?.base), children: [
    heading,
    /* @__PURE__ */ jsx15(
      "div",
      {
        ...
        children: section.items.map(
          ({ key, element }) => cloneElement5(element, {
            itemKey: key,
    ...
    hasDivider ? /* @__PURE__ */ jsx15("div", { className: mergeClassName13("oksDropdownSectionDivider", section.classNames?.divider) }) : null
  ] });
}
var DropdownItem = forwardRef9((props, ref) => {
  const {
    children,
    title,
    description,
  ...
  const [isPressedState, setIsPressedState] = useState7(false);
  const startPress = (e) => {
    if (disabled) return;
    if (!isPressedState) {
      onPressStart?.(e);
  ...
  const itemEl = /* @__PURE__ */ jsxs13(
    Component,
    {
      ...
      children: [
        startContent !== void 0 && startContent !== null ? /* @__PURE__ */ jsx15("span", { className: "oksDropdownItemStartContent", "aria-hidden": "true", children: startContent }) : null,
        /* @__PURE__ */ jsxs13(
          "span",
          {
            ...
            children: [
              ...
              description !== void 0 && description !== null ? /* @__PURE__ */ jsx15(
                "span",
                {
                  className: mergeClassName13(
                    mergeClassName13(
        ...
        shortcut !== void 0 && shortcut !== null ? /* @__PURE__ */ jsx15(
          "span",
          {
            className: mergeClassName13(
              mergeClassName13(
        ...
        endContent !== void 0 && endContent !== null ? /* @__PURE__ */ jsx15("span", { className: "oksDropdownItemEndContent", "aria-hidden": "true", children: endContent }) : resolvedSelected && effectiveHideSelectedIcon !== true ? /* @__PURE__ */ jsx15(
          "span",
          {
            className: mergeClassName13(
              mergeClassName13(
  ...
  return showDivider ? /* @__PURE__ */ jsxs13(Fragment2, { children: [
    itemEl,
    /* @__PURE__ */ jsx15("div", { className: "oksDropdownItemDivider", "aria-hidden": "true" })
  ] }) : itemEl;
});
...
import { useEffect as useEffect7, useId as useId4, useMemo as useMemo6, useRef as useRef6 } from "react";
...
function Modal(props) {
  ...
  const lastFocusedRef = useRef6(null);
  useEffect7(() => {
    if (!isOpen) return;
    if (typeof document === "undefined") return;
    lastFocusedRef.current = document.activeElement;
  ...
  const resolvedWidth = useMemo6(() => resolveWidth2(size), [size]);
  const cssVars = useMemo6(() => {
    return {
  ...
  const safeBackdropOverrides = useMemo6(() => {
    if (!backdrop) return {};
    const {
      isOpen: _isOpen,
      onClose: _onClose,
  ...
  const resolvedHeaders = {
    as: "h4",
    ...restHeaders,
    ...headerTitle !== void 0 && headerTitle !== null ? { title: /* @__PURE__ */ jsx16("span", { id: titleId, children: headerTitle }) } : {}
  };
  const hasHeader = dismissible || resolvedHeaders.title !== void 0;
  const ariaLabelledBy = headerTitle !== void 0 && headerTitle !== null ? titleId : void 0;
  const mergedDivider = {
  ...
  return /* @__PURE__ */ jsx16(Backdrop, { isOpen, onClose, ...mergedBackdrop, children: /* @__PURE__ */ jsxs14(
    "div",
    {
      ref: panelRef,
      role: "dialog",
      ...
      style: rootStyle,
      children: [
        hasHeader ? /* @__PURE__ */ jsxs14("div", { className: "oksModalHeader", children: [
          /* @__PURE__ */ jsx16("div", { className: "oksModalHeaderTitle", children: resolvedHeaders.title !== void 0 && resolvedHeaders.title !== null ? /* @__PURE__ */ jsx16(PageTitle, { ...resolvedHeaders }) : null }),
        ...
        hasHeader ? /* @__PURE__ */ jsx16(Divider, { ...mergedDivider }) : null,
        /* @__PURE__ */ jsx16("div", { className: "oksModalBody", children }),
        actions !== void 0 && actions !== null ? /* @__PURE__ */ jsx16("div", { className: "oksModalFooter", children: actions }) : null
      ]
    }
  ) });
}
...
function isTabElement(node) {
  return isValidElement6(node) && node.type === Tab;
}
...
var Tabs = forwardRef10(function Tabs2(props, ref) {
  const {
    children,
    variant = "solid",
    color = "default",
  ...
  const renderedTabs = useMemo7(() => {
    ...
    const out = [];
    for (const node of Children3.toArray(children)) {
  ...
  const keys = useMemo7(() => renderedTabs.map((t) => t.key), [renderedTabs]);
  const nodeEnv = globalThis?.process?.env?.NODE_ENV;
  if (nodeEnv !== "production") {
    for (const t of items !== void 0 ? [] : Children3.toArray(children)) {
  ...
  const triggerRefs = useRef7(/* @__PURE__ */ new Map());
  const setTriggerRef = useCallback4((k, node) => {
    triggerRefs.current.set(k, node);
  }, []);
  const autoId = useId5();
  const tabsId = useMemo7(() => {
    const base = rest.id ? keyToIdPart(rest.id) : keyToIdPart(`tabs-${autoId}`);
    return `oks-${base}`;
  }, [autoId, rest.id]);
  const getIds = useCallback4(
    (k) => {
  ...
  const positionCursor = useCallback4(() => {
      ...
      children: [
        /* @__PURE__ */ jsxs15(
          "div",
          {
            ...
            children: [
              variant === "underlined" ? /* @__PURE__ */ jsx17(
                "div",
                {
              ...
              renderedTabs.map((t) => {
                ...
                const content = /* @__PURE__ */ jsx17("span", { className: tabContentClassName, children: t.props.title });
                return /* @__PURE__ */ jsx17("div", { className: tabWrapperClassName, children: t.props.href ? /* @__PURE__ */ jsx17(
                  "a",
                  {
                    ...commonProps,
        ...
        /* @__PURE__ */ jsx17("div", { className: panelsClassName, children: destroyInactiveTabPanel ? activeTab ? /* @__PURE__ */ jsx17(
          "div",
          {
...
import { forwardRef as forwardRef11, useCallback as useCallback5, useEffect as useEffect9, useMemo as useMemo8, useRef as useRef8, useState as useState9 } from "react";
...
var TabsLegacy = forwardRef11(function TabsLegacy2(props, ref) {
  const {
    data,
    defaultTab = 0,
    value,
  ...
  const findDefault = useCallback5(
    (idx) => {
  ...
  const indexFromParam = useCallback5(() => {
      ...
      children: [
        /* @__PURE__ */ jsxs16(
          "div",
          {
            ...
            ref: tablistRef,
            children: [
              effAppearance === "underline" ? /* @__PURE__ */ jsx18("div", { className: "oksTabsIndicator", ref: indicatorRef, "aria-hidden": "true" }) : null,
              items.map((it, i) => {
        ...
        /* @__PURE__ */ jsx18("div", { className: "oksTabsPanels", children: renderLazy ? /* @__PURE__ */ jsx18(
          "div",
          {
...
import { forwardRef as forwardRef12, useCallback as useCallback6, useEffect as useEffect10, useId as useId6, useMemo as useMemo9, useState as useState10 } from "react";
...
var TabsRoot = forwardRef12(
  function TabsRoot2(props, ref) {
    ...
    const [internal, setInternal] = useState10(initial);
    ...
    const autoId = useId6();
    const idsBase = useMemo9(() => {
      const base = id ? toIdPart(id) : toIdPart(`tabs-${autoId}`);
      return `oks-${base}`;
    }, [autoId, id]);
    const getIds = useCallback6(
      (v) => {
    ...
    const rootClass = ["oksTabsRoot", className].filter(Boolean).join(" ");
    return /* @__PURE__ */ jsx19(TabsContext.Provider, { value: ctx, children: /* @__PURE__ */ jsx19(
      "div",
      {
        ref,
        id,
...
import { forwardRef as forwardRef13, useEffect as useEffect11, useRef as useRef9 } from "react";
import { jsx as jsx20, jsxs as jsxs17 } from "react/jsx-runtime";
var TabList = forwardRef13(function TabList2(props, ref) {
  ...
  return /* @__PURE__ */ jsxs17(
    "div",
    {
      ...
      onKeyDown,
      children: [
        ctx.appearance === "underline" ? /* @__PURE__ */ jsx20("div", { className: "oksTabsIndicator", ref: indicatorRef, "aria-hidden": "true" }) : null,
        props.children
      ]
    }
  );
  ...
  function TabTrigger2(props, ref) {
    ...
    return /* @__PURE__ */ jsx21(
      "button",
      {
        ...
        children: /* @__PURE__ */ jsx21("span", { className: "oksTabLabel", children })
      }
    );
  }
);
...
var TabPanel = forwardRef15(function TabPanel2(props, ref) {
...
function isToastOptions(value) {
  ...
  if (isValidElement7(value)) return false;
  const v = value;
...
function ToastRow({
  ...
  const timerId = useRef10(null);
  const startedAt = useRef10(0);
  const remainingMs = useRef10(duration ?? 0);
  const progressRef = useRef10(null);
  const canShowDurationBar = stackIndex === 0 && item.showDurationBar && duration != null;
  const setDurationBar = useCallback7(
    (ratio, transitionMs) => {
  ...
  const startDurationBar = useCallback7(
    (ms) => {
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs18(
        "div",
        {
          ...
          children: [
            item.type === "loading" && item.loadingComponent ? /* @__PURE__ */ jsx23(
              "div",
              {
            ...
            ) : item.showIcon ? /* @__PURE__ */ jsx23(
              "div",
              {
                className: mergeClassName16("oksToastIcon", classNames?.icon),
                "aria-hidden": "true",
                children: item.icon ?? /* @__PURE__ */ jsx23(StatusIcon, { type: item.type })
              }
            ) : null,
            /* @__PURE__ */ jsxs18("div", { className: mergeClassName16("oksToastBody", classNames?.content), children: [
              hasTitle && /* @__PURE__ */ jsx23("div", { className: mergeClassName16("oksToastTitle", classNames?.title), children: item.title }),
              hasDescription && /* @__PURE__ */ jsx23(
                "div",
                {
            ...
            stackIndex === 0 && (item.action || item.endContent || item.dismissible) && /* @__PURE__ */ jsxs18("div", { className: mergeClassName16("oksToastControls", classNames?.wrapper), children: [
              item.action && /* @__PURE__ */ jsx23(
                "button",
                {
                  type: "button",
              ...
              item.endContent,
              item.dismissible && /* @__PURE__ */ jsx23(
                CloseButton,
                {
                  ariaLabel: "Close",
            ...
            canShowDurationBar && /* @__PURE__ */ jsx23(
              "div",
              {
                className: mergeClassName16(
...
function ToastProvider({
  ...
  const idCounter = useRef10(0);
  const removalTimers = useRef10(/* @__PURE__ */ new Map());
  const [items, dispatch] = useReducer(toastReducer, []);
  const itemsRef = useRef10([]);
  itemsRef.current = items;
  const scheduleRemoval = useCallback7(
    (id) => {
  ...
  const update = useCallback7((id, patch) => {
  ...
  return /* @__PURE__ */ jsxs18(ToastContext.Provider, { value: api, children: [
    children,
    /* @__PURE__ */ jsx23(Portal, { container, children: Object.entries(grouped).map(([posKey, list]) => {
      const pos = posKey;
        ...
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx23(
            "div",
            {
              ...
              children: visual.map((t, visualIndex) => /* @__PURE__ */ jsx23(
                ToastRow,
                {
                  item: t,
                  dataMotion,
...
import { useEffect as useEffect19, useId as useId16, useMemo as useMemo17, useRef as useRef14, useState as useState18 } from "react";

// src/components/FormFieldSet/CustomFormElements/CheckboxGroupField/CheckboxGroupField.tsx
import { forwardRef as forwardRef16, useEffect as useEffect13, useId as useId7, useState as useState11 } from "react";
...
var CheckboxGroupField = forwardRef16((props, ref) => {
  const {
    label,
    labelPlacement,
    description,
  ...
  return /* @__PURE__ */ jsxs19(
    "div",
    {
      ...
      style: { ...toneVars, ...style },
      children: [
        label ? /* @__PURE__ */ jsxs19("div", { className: "oksCheckboxGroupFieldLabel", children: [
          label,
          required ? /* @__PURE__ */ jsx24("span", { "aria-hidden": "true", children: "*" }) : null
        ] }) : null,
        /* @__PURE__ */ jsx24("div", { role: "group", "aria-describedby": ariaDescribedBy || void 0, children: /* @__PURE__ */ jsx24("div", { className: "oksCheckboxGroupFieldItems", children: options.map((opt, idx) => {
          ...
          return /* @__PURE__ */ jsxs19(
            "label",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx24("span", { className: "oksCheckboxGroupFieldItemLabel", children: opt.label })
              ]
            },
            opt.key ?? `${idx}-${opt.value}`
          );
        }) }) }),
        description ? /* @__PURE__ */ jsx24("div", { id: descriptionId, className: "oksCheckboxGroupFieldDescription", children: description }) : null,
        error && error !== true ? /* @__PURE__ */ jsx24("div", { id: errorId, className: "oksCheckboxGroupFieldError", role: "alert", children: error }) : null
      ]
    }
  );
});
...
import { forwardRef as forwardRef17, useEffect as useEffect14, useId as useId8, useMemo as useMemo11, useRef as useRef11, useState as useState12 } from "react";
...
var SelectField = forwardRef17(
  (props, ref) => {
    ...
    const [uncontrolledValue, setUncontrolledValue] = useState12(() => {
    ...
    const isPlaceholderShown = useMemo11(() => {
    ...
    const typeaheadRef = useRef11({
      value: "",
      timer: null
    });
    const [isOpen, setIsOpen] = useState12(false);
    const [activeIndex, setActiveIndex] = useState12(0);
    const [menuStyle, setMenuStyle] = useState12(null);
    const [filterQuery, setFilterQuery] = useState12("");
    const valueLabelMap = useMemo11(() => {
      const map = /* @__PURE__ */ new Map();
    ...
    const visibleIndices = useMemo11(
    ...
    return /* @__PURE__ */ jsxs20(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          topLabel ? /* @__PURE__ */ jsxs20("label", { className: "oksSelectFieldLabel", htmlFor: fieldId, children: [
            topLabel,
            required ? /* @__PURE__ */ jsx25("span", { "aria-hidden": "true", children: "*" }) : null
          ] }) : null,
          /* @__PURE__ */ jsxs20("div", { className: "oksSelectFieldControl", children: [
            isNative ? /* @__PURE__ */ jsxs20(
              "select",
              {
                ...rest,
                ref,
                ...
                children: [
                  canRenderPlaceholderOption ? /* @__PURE__ */ jsx25("option", { value: "", disabled: required, children: placeholderOption }) : null,
                  options.map((opt, idx) => /* @__PURE__ */ jsx25(
                    "option",
                    {
                      value: opt.value,
              ...
              /* @__PURE__ */ jsx25(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsx25("span", { className: "oksSelectFieldTriggerValue", children: isMultiple ? selectedValues.length < 1 ? placeholderOption : /* @__PURE__ */ jsx25("span", { className: "oksSelectFieldChips", children: selectedValues.map((v) => /* @__PURE__ */ jsx25(
                    Chip,
                    {
                      size: "sm",
                      variant: "flat",
                      endContent: /* @__PURE__ */ jsx25(
                        "span",
                        {
              ...
              isOpen ? /* @__PURE__ */ jsx25(Portal, { children: /* @__PURE__ */ jsxs20(
                "div",
                {
                  ref: menuRef,
                  id: menuId,
                  ...
                  children: [
                    /* @__PURE__ */ jsx25("div", { className: "oksSelectFieldFilter", children: /* @__PURE__ */ jsx25(
                      "input",
                      {
            ...
            floatingLabel ? /* @__PURE__ */ jsxs20("label", { className: "oksSelectFieldLabel", htmlFor: fieldId, children: [
              floatingLabel,
              required ? /* @__PURE__ */ jsx25("span", { "aria-hidden": "true", children: "*" }) : null
            ] }) : null
          ] }),
          description ? /* @__PURE__ */ jsx25("div", { id: descriptionId, className: "oksSelectFieldDescription", children: description }) : null,
          error && error !== true ? /* @__PURE__ */ jsx25("div", { id: errorId, className: "oksSelectFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
var DatePickerField = forwardRef18((props, ref) => {
  const {
    label,
    labelPlacement = "top",
    description,
  ...
  const triggerWrapRef = useRef12(null);
  const startTriggerRef = useRef12(null);
  const endTriggerRef = useRef12(null);
  ...
  const [panel, setPanel] = useState13(
  ...
  const popoverThemeVars = useMemo12(() => {
    const result = { ...toneVars };
    if (style && typeof style === "object") {
      for (const [k, v] of Object.entries(style)) {
        if (k.startsWith("--")) result[k] = v;
  ...
  const monthsToShow = useMemo12(() => {
    const v = Number(monthsToShowProp);
    if (v === 1 || v === 2) return v;
    return range ? 2 : 1;
  }, [monthsToShowProp, range]);
  const displayValue = useMemo12(
  ...
  const displayStartValue = useMemo12(() => {
    if (!range) return "";
  ...
  const minDayKey = useMemo12(
    () => normalizeConstraintDayKey(minDate),
    [minDate]
  );
  const maxDayKey = useMemo12(
    () => normalizeConstraintDayKey(maxDate),
    [maxDate]
  );
  const blockedDaySet = useMemo12(() => {
    const set = /* @__PURE__ */ new Set();
  ...
  const isDayDisabled = useCallback8(
    (d) => {
  ...
  const minDayDate = useMemo12(
    () => minDayKey ? parseDateOnly(minDayKey) : null,
    [minDayKey]
  );
  const maxDayDate = useMemo12(
    () => maxDayKey ? parseDateOnly(maxDayKey) : null,
    [maxDayKey]
  );
  const clampToMinMax = useCallback8(
    (d) => {
  ...
  const moveToAllowedDay = useCallback8(
    (d, dir) => {
  ...
  const constrainPresetValue = useCallback8(
    (v) => {
  ...
  const [viewMonth, setViewMonth] = useState13(() => {
  ...
  const wasOpenRef = useRef12(false);
  const prevRangePartRef = useRef12("start");
  useEffect15(() => {
  ...
  const hoursOptions = useMemo12(
    () => Array.from({ length: 12 }, (_, i) => String(i + 1)),
    []
  );
  const minutesOptions = useMemo12(
  ...
  return /* @__PURE__ */ jsxs21(
    "div",
    {
      ...
      style: { ...toneVars, ...style },
      children: [
        topLabel ? /* @__PURE__ */ jsxs21("label", { className: "oksDatePickerFieldLabel", htmlFor: baseId, children: [
          topLabel,
          required ? /* @__PURE__ */ jsx26("span", { "aria-hidden": "true", children: "*" }) : null
        ] }) : null,
        /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldControl", children: [
          /* @__PURE__ */ jsxs21(
            "div",
            {
              ref: triggerWrapRef,
              ...
              children: [
                range && rangeTrigger === "dual" ? /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldDualTrigger", children: [
                  /* @__PURE__ */ jsx26(
                    "input",
                    {
                      ref: (node) => {
                  ...
                  /* @__PURE__ */ jsx26("span", { className: "oksDatePickerFieldDualArrow", "aria-hidden": "true", children: /* @__PURE__ */ jsx26(
                    "svg",
                    {
                      width: "14",
                      height: "14",
                ...
                floatingLabel ? /* @__PURE__ */ jsxs21("label", { className: "oksDatePickerFieldLabel", htmlFor: baseId, children: [
                  floatingLabel,
                  required ? /* @__PURE__ */ jsx26("span", { "aria-hidden": "true", children: "*" }) : null
                ] }) : null,
                clearable && hasValue ? /* @__PURE__ */ jsx26(
                  "button",
                  {
                    type: "button",
                ...
                /* @__PURE__ */ jsx26("span", { className: "oksDatePickerFieldIcon", "aria-hidden": "true", children: /* @__PURE__ */ jsxs21(
                  "svg",
                  {
                    width: "18",
                    height: "18",
          ...
          isOpen ? /* @__PURE__ */ jsx26(Portal, { children: /* @__PURE__ */ jsxs21(
            "div",
            {
              ref: popoverRef,
              id: popoverId,
              ...
              children: [
                showRangePresets && panel === "presets" ? /* @__PURE__ */ jsx26(
                  "div",
                  {
                    className: "oksDatePickerFieldPresetsList",
                    role: "listbox",
                    "aria-label": "Presets",
                    children: presetKeys.map((k) => /* @__PURE__ */ jsx26(
                      "button",
                      {
                        type: "button",
                    ...
                    children: [
                      /* @__PURE__ */ jsxs21(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            monthsToShow === 1 ? /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldMonthLabel", children: [
                              viewMonth.toLocaleString(void 0, { month: "long" }),
                              " ",
                              viewMonth.getFullYear()
                            ] }) : /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldMonthLabels", children: [
                              /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldMonthLabel", children: [
                      ...
                      /* @__PURE__ */ jsx26(
                        "div",
                        {
                          ...
                          "data-months": String(monthsToShow),
                          children: monthGrids.map(({ month, cells }) => /* @__PURE__ */ jsxs21(
                            "div",
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsx26(
                                  "div",
                                  {
                                    ...
                                    "aria-hidden": "true",
                                    children: ["S", "M", "T", "W", "T", "F", "S"].map((d, idx) => /* @__PURE__ */ jsx26(
                                      "div",
                                      {
                                ...
                                /* @__PURE__ */ jsx26(
                                  "div",
                                  {
                                    ...
                                    children: cells.map((cell) => /* @__PURE__ */ jsx26(
                                      "button",
                                      {
                                        type: "button",
                                        role: "gridcell",
                      ...
                      withTime ? /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTime", children: [
                        /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeTitle", children: "Select Time" }),
                        !range ? /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeRow", children: [
                          /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeCol", children: [
                            /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeLabel", children: "Hours" }),
                            /* @__PURE__ */ jsx26(
                              SelectField,
                              {
                                native: true,
                          ...
                          /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeCol", children: [
                            /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeLabel", children: "Minutes" }),
                            /* @__PURE__ */ jsx26(
                              SelectField,
                              {
                                native: true,
                          ...
                          /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeCol", children: [
                            /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeLabel", children: "Period" }),
                            /* @__PURE__ */ jsx26(
                              SelectField,
                              {
                                native: true,
                        ...
                        ] }) : /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeRange", children: [
                          /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeRangeBlock", children: [
                            /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeSubTitle", children: "Start" }),
                            /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeRow", children: [
                              /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeCol", children: [
                                /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeLabel", children: "Hours" }),
                                /* @__PURE__ */ jsx26(
                                  SelectField,
                          ...
                          /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeRangeBlock", children: [
                            /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeSubTitle", children: "End" }),
                            /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeRow", children: [
                              /* @__PURE__ */ jsxs21("div", { className: "oksDatePickerFieldTimeCol", children: [
                                /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldTimeLabel", children: "Hours" }),
                                /* @__PURE__ */ jsx26(
                ...
                showRangePresets && panel === "calendar" ? /* @__PURE__ */ jsx26("div", { className: "oksDatePickerFieldBackToPresets", children: /* @__PURE__ */ jsx26(
                  "button",
                  {
                    type: "button",
        ...
        description ? /* @__PURE__ */ jsx26("div", { id: descriptionId, className: "oksDatePickerFieldDescription", children: description }) : null,
        error && error !== true ? /* @__PURE__ */ jsx26("div", { id: errorId, className: "oksDatePickerFieldError", role: "alert", children: error }) : null
      ]
    }
  );
});
...
import { forwardRef as forwardRef19, useId as useId10, useMemo as useMemo13, useState as useState14 } from "react";
...
var PasswordField = forwardRef19(
  (props, ref) => {
    const {
      label,
      labelPlacement = "top",
    ...
    const isInvalid = Boolean(error);
    const resolvedPlaceholder = useMemo13(() => {
    ...
    const requirementRows = useMemo13(() => {
      const rows = [];
    ...
    const requirementsTitle = useMemo13(() => {
      if (!strongPassword) return null;
      if (evalResult)
    ...
    return /* @__PURE__ */ jsxs22(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          topLabel ? /* @__PURE__ */ jsxs22("label", { className: "oksTextFieldLabel", htmlFor: inputId, children: [
            topLabel,
            required ? /* @__PURE__ */ jsx27("span", { "aria-hidden": "true", children: "*" }) : null
          ] }) : null,
          /* @__PURE__ */ jsxs22(
            "div",
            {
              ...
              children: [
                hasStart ? /* @__PURE__ */ jsxs22("span", { className: "oksTextFieldAdornment oksTextFieldStart", children: [
                  startIcon != null ? /* @__PURE__ */ jsx27("span", { className: "oksTextFieldIcon", children: startIcon }) : null,
                  prefix != null ? /* @__PURE__ */ jsx27("span", { className: "oksTextFieldAffix", children: prefix }) : null
                ] }) : null,
                /* @__PURE__ */ jsxs22("div", { className: "oksTextFieldInputSlot", children: [
                  /* @__PURE__ */ jsx27(
                    "input",
                    {
                      ...rest,
                  ...
                  floatingLabel ? /* @__PURE__ */ jsxs22("label", { className: "oksTextFieldLabel", htmlFor: inputId, children: [
                    floatingLabel,
                    required ? /* @__PURE__ */ jsx27("span", { "aria-hidden": "true", children: "*" }) : null
                  ] }) : null
                ] }),
                hasEnd ? /* @__PURE__ */ jsxs22("span", { className: "oksTextFieldAdornment oksTextFieldEnd", children: [
                  suffix != null ? /* @__PURE__ */ jsx27("span", { className: "oksTextFieldAffix", children: suffix }) : null,
                  endIcon != null ? /* @__PURE__ */ jsx27("span", { className: "oksTextFieldIcon", children: endIcon }) : null,
                  revealToggle ? /* @__PURE__ */ jsx27(
                    "button",
                    {
                      type: "button",
                      ...
                      children: revealed ? /* @__PURE__ */ jsx27(EyeOffIcon, {}) : /* @__PURE__ */ jsx27(EyeIcon, {})
                    }
                  ) : null
                ] }) : null,
                shouldShowRequirements && requirementRows.length > 0 ? /* @__PURE__ */ jsxs22("div", { id: requirementsId, className: "oksPasswordFieldRequirements", children: [
                  requirementsTitle ? /* @__PURE__ */ jsx27("div", { className: "oksPasswordFieldRequirementsTitle", children: requirementsTitle }) : null,
                  /* @__PURE__ */ jsx27("ul", { className: "oksPasswordFieldRequirementsList", children: requirementRows.map((row) => /* @__PURE__ */ jsxs22(
                    "li",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsx27(
                          "span",
                          {
                            ...
                            "aria-hidden": "true",
                            children: /* @__PURE__ */ jsx27(StatusIcon, { type: row.met ? "success" : "error" })
                          }
                        ),
                        /* @__PURE__ */ jsx27("span", { children: row.label })
                      ]
                    },
                    row.key
                  )) })
          ...
          description ? /* @__PURE__ */ jsx27("div", { id: descriptionId, className: "oksTextFieldDescription", children: description }) : null,
          shouldShowRequirements ? null : error && error !== true ? /* @__PURE__ */ jsx27("div", { id: errorId, className: "oksTextFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
import { forwardRef as forwardRef20, useEffect as useEffect16, useId as useId11, useMemo as useMemo14, useState as useState15 } from "react";
...
var PhoneField = forwardRef20(
  (props, ref) => {
    ...
    const codeOptions = useMemo14(
      () => resolvedCountries.map((c) => ({
        label: /* @__PURE__ */ jsxs23("span", { className: "oksPhoneCountryOption", children: [
          c.flag ? /* @__PURE__ */ jsx28("span", { className: "oksPhoneCountryFlag", children: c.flag }) : getCountryShort(c) ? /* @__PURE__ */ jsx28("span", { className: "oksPhoneCountryShort", children: getCountryShort(c) }) : null,
          getCountryName(c) ? /* @__PURE__ */ jsx28("span", { className: "oksPhoneCountryName", children: getCountryName(c) }) : null,
          /* @__PURE__ */ jsx28("span", { className: "oksPhoneCountryCode", children: c.code })
        ] }),
        value: c.code,
        key: c.key ?? c.code
      })),
    ...
    const resolvedPhonePlaceholder = useMemo14(() => {
    ...
    return /* @__PURE__ */ jsxs23(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          topLabel ? /* @__PURE__ */ jsxs23("label", { className: "oksPhoneFieldLabel", htmlFor: `${baseId}-phone`, children: [
            topLabel,
            required ? /* @__PURE__ */ jsx28("span", { "aria-hidden": "true", children: "*" }) : null
          ] }) : null,
          /* @__PURE__ */ jsxs23("div", { className: "oksPhoneFieldControl", children: [
            countryCodeMode === "select" ? /* @__PURE__ */ jsxs23("div", { className: "oksPhoneFieldCode", children: [
              /* @__PURE__ */ jsx28(
                SelectField,
                {
              ...
              /* @__PURE__ */ jsx28("span", { className: "oksPhoneDialCode", "aria-hidden": "true", children: String(currentValue.code ?? "") })
            ] }) : null,
            /* @__PURE__ */ jsxs23("div", { className: "oksPhoneFieldInputWrap", children: [
              /* @__PURE__ */ jsx28(
                "input",
                {
                  ...rest,
              ...
              floatingLabel ? /* @__PURE__ */ jsxs23("label", { className: "oksPhoneFieldLabel", htmlFor: `${baseId}-phone`, children: [
                floatingLabel,
                required ? /* @__PURE__ */ jsx28("span", { "aria-hidden": "true", children: "*" }) : null
              ] }) : null
            ] })
          ] }),
          description ? /* @__PURE__ */ jsx28("div", { id: descriptionId, className: "oksPhoneFieldDescription", children: description }) : null,
          error && error !== true ? /* @__PURE__ */ jsx28("div", { id: errorId, className: "oksPhoneFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
import { forwardRef as forwardRef21, useEffect as useEffect17, useId as useId12, useState as useState16 } from "react";
...
var RadioGroupField = forwardRef21(
  (props, ref) => {
    const {
      label,
      description,
    ...
    return /* @__PURE__ */ jsxs24(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          label ? /* @__PURE__ */ jsxs24("div", { className: "oksRadioGroupFieldLabel", children: [
            label,
            required ? /* @__PURE__ */ jsx29("span", { "aria-hidden": "true", children: "*" }) : null
          ] }) : null,
          /* @__PURE__ */ jsx29("div", { role: "radiogroup", "aria-describedby": ariaDescribedBy || void 0, children: /* @__PURE__ */ jsx29("div", { className: "oksRadioGroupFieldItems", children: options.map((opt, idx) => {
            const optionId = `${groupId}-${opt.key ?? `${idx}-${opt.value}`}`;
            ...
            return /* @__PURE__ */ jsxs24(
              "label",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx29("span", { className: "oksRadioGroupFieldItemLabel", children: opt.label })
                ]
              },
              opt.key ?? `${idx}-${opt.value}`
            );
          }) }) }),
          description ? /* @__PURE__ */ jsx29("div", { id: descriptionId, className: "oksRadioGroupFieldDescription", children: description }) : null,
          error && error !== true ? /* @__PURE__ */ jsx29("div", { id: errorId, className: "oksRadioGroupFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
import { forwardRef as forwardRef22, useId as useId13 } from "react";
...
// src/components/FormFieldSet/CustomFormElements/SwitchField/SwitchField.tsx
import { Fragment as Fragment4, jsx as jsx30, jsxs as jsxs25 } from "react/jsx-runtime";
var SwitchField = forwardRef22(
  (props, ref) => {
    const {
      label,
      labelPlacement = "top",
    ...
    return /* @__PURE__ */ jsxs25(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          /* @__PURE__ */ jsxs25("label", { ref, className: "oksSwitchFieldRow", htmlFor: switchId, children: [
            resolvedLabelPlacement === "top" && label ? /* @__PURE__ */ jsxs25("span", { className: "oksSwitchFieldLabel", children: [
              label,
              required ? /* @__PURE__ */ jsx30("span", { "aria-hidden": "true", children: "*" }) : null
            ] }) : null,
            /* @__PURE__ */ jsxs25("span", { className: "oksSwitchFieldControl", children: [
              /* @__PURE__ */ jsx30(
                "input",
                {
                  ...rest,
              ...
              /* @__PURE__ */ jsxs25(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsx30("span", { className: "oksSwitchFieldTrack", "aria-hidden": "true", children: /* @__PURE__ */ jsx30("span", { className: "oksSwitchFieldThumb" }) }),
                    showStateText ? /* @__PURE__ */ jsxs25(Fragment4, { children: [
                      /* @__PURE__ */ jsx30(
                        "span",
                        {
                      ...
                      /* @__PURE__ */ jsx30("span", { className: "oksSwitchFieldStateText", "data-state": "checked", children: checkedText })
                    ] }) : null
                  ]
                }
              )
          ...
          description ? /* @__PURE__ */ jsx30("div", { id: descriptionId, className: "oksSwitchFieldDescription", children: description }) : null,
          error && error !== true ? /* @__PURE__ */ jsx30("div", { id: errorId, className: "oksSwitchFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
import { forwardRef as forwardRef23, useId as useId14, useMemo as useMemo15 } from "react";
...
var TextAreaField = forwardRef23(
  (props, ref) => {
    const {
      label,
      labelPlacement = "top",
    ...
    const ariaDescribedBy = [describedBy, descriptionId, errorId].filter(Boolean).join(" ");
    const isInvalid = Boolean(error);
    const resolvedPlaceholder = useMemo15(() => {
      if (labelPlacement !== "floating") return placeholder;
      if (!label) return placeholder;
      if (placeholder !== void 0) return placeholder;
      return " ";
    ...
    return /* @__PURE__ */ jsxs26(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          topLabel ? /* @__PURE__ */ jsxs26("label", { className: "oksTextAreaFieldLabel", htmlFor: fieldId, children: [
            topLabel,
            required ? /* @__PURE__ */ jsx31("span", { "aria-hidden": "true", children: "*" }) : null
          ] }) : null,
          /* @__PURE__ */ jsxs26("div", { className: "oksTextAreaFieldControl", children: [
            /* @__PURE__ */ jsx31(
              "textarea",
              {
                ...rest,
            ...
            floatingLabel ? /* @__PURE__ */ jsxs26("label", { className: "oksTextAreaFieldLabel", htmlFor: fieldId, children: [
              floatingLabel,
              required ? /* @__PURE__ */ jsx31("span", { "aria-hidden": "true", children: "*" }) : null
            ] }) : null
          ] }),
          description ? /* @__PURE__ */ jsx31("div", { id: descriptionId, className: "oksTextAreaFieldDescription", children: description }) : null,
          error && error !== true ? /* @__PURE__ */ jsx31("div", { id: errorId, className: "oksTextAreaFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
import { forwardRef as forwardRef24, useId as useId15, useMemo as useMemo16 } from "react";
import { jsx as jsx32, jsxs as jsxs27 } from "react/jsx-runtime";
var TextField = forwardRef24(
  (props, ref) => {
    const {
      label,
      labelPlacement = "top",
    ...
    const ariaDescribedBy = [describedBy, descriptionId, errorId].filter(Boolean).join(" ");
    const isInvalid = Boolean(error);
    const resolvedPlaceholder = useMemo16(() => {
      if (labelPlacement !== "floating") return placeholder;
      if (!label) return placeholder;
      if (placeholder !== void 0) return placeholder;
      return " ";
    ...
    return /* @__PURE__ */ jsxs27(
      "div",
      {
        ...
        style: { ...toneVars, ...style },
        children: [
          topLabel ? /* @__PURE__ */ jsxs27("label", { className: "oksTextFieldLabel", htmlFor: inputId, children: [
            topLabel,
            required ? /* @__PURE__ */ jsx32("span", { "aria-hidden": "true", children: "*" }) : null
          ] }) : null,
          /* @__PURE__ */ jsxs27("div", { className: "oksTextFieldControl", children: [
            hasStart ? /* @__PURE__ */ jsxs27("span", { className: "oksTextFieldAdornment oksTextFieldStart", children: [
              startIcon != null ? /* @__PURE__ */ jsx32("span", { className: "oksTextFieldIcon", children: startIcon }) : null,
              prefix != null ? /* @__PURE__ */ jsx32("span", { className: "oksTextFieldAffix", children: prefix }) : null
            ] }) : null,
            /* @__PURE__ */ jsxs27("div", { className: "oksTextFieldInputSlot", children: [
              /* @__PURE__ */ jsx32(
                "input",
                {
                  ...rest,
              ...
              floatingLabel ? /* @__PURE__ */ jsxs27("label", { className: "oksTextFieldLabel", htmlFor: inputId, children: [
                floatingLabel,
                required ? /* @__PURE__ */ jsx32("span", { "aria-hidden": "true", children: "*" }) : null
              ] }) : null
            ] }),
            hasEnd ? /* @__PURE__ */ jsxs27("span", { className: "oksTextFieldAdornment oksTextFieldEnd", children: [
              suffix != null ? /* @__PURE__ */ jsx32("span", { className: "oksTextFieldAffix", children: suffix }) : null,
              endIcon != null ? /* @__PURE__ */ jsx32("span", { className: "oksTextFieldIcon", children: endIcon }) : null
            ] }) : null
          ] }),
          description ? /* @__PURE__ */ jsx32("div", { id: descriptionId, className: "oksTextFieldDescription", children: description }) : null,
          error && error !== true ? /* @__PURE__ */ jsx32("div", { id: errorId, className: "oksTextFieldError", role: "alert", children: error }) : null
        ]
      }
    );
  }
...
var useFormContext = () => {
  const ctx = useContext4(FormContext);
  if (!ctx) {
    throw new Error("useFormContext must be used within a Form");
  }
  return ctx;
};
var useOptionalFormContext = () => useContext4(FormContext);
var Form = forwardRef25((props, ref) => {
  const {
    children,
    onSubmit,
    onError,
  ...
  const [touched, setTouched] = useState17({});
  const [isSubmitting, setIsSubmitting] = useState17(false);
  const [validationSchema, setValidationSchema] = useState17({});
  const formDataRef = useRef13(initialValues || {});
  const changeTimersRef = useRef13({});
  const usedFieldNamesRef = useRef13(/* @__PURE__ */ new Set());
  const fieldNameCountsRef = useRef13({});
  const initialValuesRef = useRef13(initialValues || {});
  useEffect18(() => {
  ...
  const getUniqueFieldName = useCallback9((baseName) => {
  ...
  const registerField = useCallback9(
  ...
  const unregisterField = useCallback9((fieldName) => {
    setValidationSchema((prev) => {
      const next = { ...prev };
  ...
  const validateFieldValue = useCallback9(
  ...
  const handleFieldChange = useCallback9(
    (fieldName, value) => {
  ...
  const handleFieldBlur = useCallback9(
    (fieldName) => {
  ...
  const reset = useCallback9((nextValues) => {
  ...
  return /* @__PURE__ */ jsx33(FormContext.Provider, { value: ctx, children: /* @__PURE__ */ jsxs28(
    "form",
    {
      ...
      ...restFormProps,
      children: [
        disableAutofill ? /* @__PURE__ */ jsxs28(Fragment5, { children: [
          /* @__PURE__ */ jsx33(
            "input",
            {
              tabIndex: -1,
...
var FormFieldSet = (props) => {
  ...
  const normalizedValidation = useMemo17(() => {
  ...
  const isRegisteredRef = useRef14(false);
  useEffect19(() => {
  ...
  const [localValue, setLocalValue] = useState18(() => {
  ...
  const [localTouched, setLocalTouched] = useState18(false);
...
import React6, { useMemo as useMemo18, useState as useState19 } from "react";
...
var cloneWithIndex = (node, index, group, nameStrategy) => {
  ...
  const mapped = React6.Children.map(
    childNodes,
    (c) => cloneWithIndex(c, index, group, nameStrategy)
  );
  return React6.cloneElement(node, { children: mapped });
};
var LoopFields = (props) => {
  ...
  const formContext = useOptionalFormContext();
  const initialCount = useMemo18(() => minItems < 1 ? 1 : minItems, [minItems]);
  const [count, setCount] = useState19(initialCount);
  ...
  return /* @__PURE__ */ jsxs29("div", { className, children: [
    controls === "top" ? /* @__PURE__ */ jsxs29("div", { style: { display: "flex", gap: "8px", alignItems: "center" }, children: [
      /* @__PURE__ */ jsx35(
        Button,
        {
          variant: "bordered",
    ...
    /* @__PURE__ */ jsx35("div", { style: { display: "flex", flexDirection: "column", gap: "16px" }, children: Array.from({ length: count }).map((_, i) => /* @__PURE__ */ jsx35("div", { style: { display: "flex", flexDirection: "column", gap: "16px" }, children: renderItem(i) }, `loop_item_${i}`)) })
  ] });
};
